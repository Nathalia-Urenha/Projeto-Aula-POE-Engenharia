...
import com.projetoum.view.menu.Menu;
...
public class Login extends JFrame {
	...
	private static final long serialVersionUID = -434677766736604755L;
	...
	private void initComponents() {
		...
		btnAcesso.setIcon(new ImageIcon(Login.class.getResource("/com/projetoum/estrutura/imagens/application_get.png")));
		
		btnCancelar = new JButton("Cancelar");
		
		btnCancelar.setIcon(new ImageIcon(Login.class.getResource("/com/projetoum/estrutura/imagens/iconFechar.png")));
		
		btnSair = new JButton("Sair");
		
		btnSair.setIcon(new ImageIcon(Login.class.getResource("/com/projetoum/estrutura/imagens/sair.png")));
